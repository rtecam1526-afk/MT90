...
def crm():
    ...
    agente_info = cfg.AGENTES.get(agente_key, cfg.AGENTES.get("gabriela", {}))
    agente_nombre = agente_info.get("nombre", agente_key.title())

    # New React-based CRM (serves crm_nuevo.html template)
    try:
    ...
    # Fallback: old McKinsey CRM with inject
